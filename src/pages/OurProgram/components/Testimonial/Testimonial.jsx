...
export default function Testimonial() {
  return (
    <div
      ...
      style={{ width: "auto", maxWidth: "600px", height: "auto", boxShadow: "2px 2px 4px 2px rgba(0, 0, 0, 0.3)" , border:"0px solid black" , borderRadius:"15px", marginRight: "5px",marginLeft: "5px" }}
    >
