    ...
    <div className='d-flex flex-column justify-content-center align-items-center'>
        ...
        <div className="card cross_card" style={{width: '60%', height:'227px'}}>
            <div className="card-body-2 p-0 d-flex justify-content-center align-items-center flex-column">
              ...
              <img src="/imgs/cross_card1.png" className="vertical_card_img" alt="" style={{marginBottom:'0px'}}/>
          ...
          <div className="card cross_card"  style={{width: '60%', height:'227px'}}>
            ...
            <img src="/imgs/cross_card2.png"  className="vertical_card_img" alt="" style={{marginBottom:'0px'}}/>
          ...
          <div className="card cross_card"  style={{width: '60%' , height:'227px'}}>
            <div className="card-body-2  d-flex justify-content-center align-items-center flex-column">
            <img src="/imgs/cross_card3.png" className="vertical_card_img" alt="" style={{marginBottom:'0px' , height:'50px'}} />
          ...
          <div className="card cross_card" style={{width: '60%',height:'227px'}}>
            <div className="card-body-2 d-flex justify-content-center align-items-center flex-column">
            <img src="/imgs/cross_card4.png" className="vertical_card_img" alt="" style={{marginBottom:'0px'}}/>
